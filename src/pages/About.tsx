...
export default function About() {
  return (
    <PublicPageLayout
      ...
      description="Tawasel App brings inbox collaboration, CRM structure, AI automation, and subscription controls into one workspace so growing teams can run customer conversations without stitching tools together."
      sections={[
        {
          title: 'What Tawasel App helps teams do',
          paragraphs: [
            'Tawasel App is designed for businesses that depend on WhatsApp to support customers, qualify leads, and manage day-to-day conversations.',
