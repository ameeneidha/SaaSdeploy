...
export default function Careers() {
  return (
    <PublicPageLayout
      ...
      description="Tawasel App is evolving from a powerful internal product foundation into a more polished SaaS experience. We care about practical automation, calm UI, and tools that make operators faster."
      sections={[
        {
          title: 'What we value',
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            'There is no public job board in this environment yet, but interest and portfolio links can be routed through Tawasel while the careers workflow is still being finalized.',
          ...
          bullets: ['Visit tawasel.io to start a conversation about open roles or collaboration.'],
        },
      ]}
      ctaLabel="Learn more"
      ctaHref="/about"
